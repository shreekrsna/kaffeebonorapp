...
const Chef = () => (
  <div className='chef__bg sm:flex-row flex-col bg-black-gradient-2 app__bg box-shadow p-5' id='chef'>
    <div className="flex-1 flex justify-start items-start flex-col text-container ml-4">
      <h2 className={`${styles.heading2} headtext__cormorant`}>Let's Explore the Coffee World...</h2>
      
      <p className="max-w-[470px] mt-5 text-gray-400 text-sm">
      ...
      <p className='mt-5 max-w-[470px] text-gray-400 text-sm'>
      ...
      <p className="text-sm text-gray-400 max-w-[470px] mt-5">
